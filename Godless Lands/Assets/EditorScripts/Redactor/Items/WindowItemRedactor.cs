...
namespace ItemsRedactor
{
    public class WindowItemRedactor : EditorWindow
    {
        ...
        private ItemsContainer itemsList;
        ...
        private void OnEnable()
        {
            ...
            itemsList = AssetDatabase.LoadAssetAtPath<ItemsContainer>(path);
        }
        ...
        private void DrawMenu()
        {
            ...
            if (GUILayout.Button("", redactorStyle.Delet, GUILayout.Height(25), GUILayout.Width(25)))
            {
                if (select_editor._item != null && select_editor._item.id != 0)
                {
                    ...
                    {
                        itemsList.Remove(select_editor._item);
            ...
            itemsList = EditorGUILayout.ObjectField(itemsList, typeof(ItemsContainer), false) as ItemsContainer;
        ...
        public static void Save(ItemsContainer itemsList)
        {
        ...
        public static ItemsContainer Create()
        {
            ItemsContainer asset = ScriptableObject.CreateInstance<ItemsContainer>();
